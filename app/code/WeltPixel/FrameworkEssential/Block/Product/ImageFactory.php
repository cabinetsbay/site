<?php
namespace WeltPixel\FrameworkEssential\Block\Product;
...
class ImageFactory extends \Magento\Catalog\Block\Product\ImageFactory
{
    ...
    public function create(Product $product, string $imageId, array $attributes = null): ImageBlock
    {
        ...
        if ($this->isLazyLoadModuleEnabled()) {
            $data['data']['template'] = 'WeltPixel_FrameworkEssential::product/image_with_borders.phtml';
        } else {
            $data['data']['template'] = 'WeltPixel_FrameworkEssential::product/nolazyload/image_with_borders.phtml';
        }
