<?php
namespace WeltPixel\FrameworkEssential\Helper;

/**
 * Class Data
 * @package WeltPixel\FrameworkEssential\Helper
 */
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getListItemsTemplate()
    {
        ...
        if ($this->isGoogleTagManagerProductClickTrackingEnabled() && $this->isOwlCarouselEnabled()) {
            $templateName = 'WeltPixel_FrameworkEssential::product/list/items.phtml';
